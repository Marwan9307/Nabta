...
<div class="modal fade" id="addItemModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="/item/create" enctype="multipart/form-data" id="closetAddItemForm">
          <div class="row g-3">
            <div class="col-md-6"><input name="title" class="form-control" placeholder="Name" required></div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <select name="material_type" class="form-select" required>
                <option value="">Material</option><option>cotton</option><option>polyester</option><option>denim</option><option>wool</option><option>silk</option><option>linen</option><option>leather</option>
              </select>
            </div>
            <div class="col-md-3"><input name="price" type="number" class="form-control" placeholder="Price (EGP)" min="1" step="0.01" required></div>
            <div class="col-md-3"><input name="weight" type="number" step="0.1" min="0" class="form-control" placeholder="Weight (kg)"></div>
            <div class="col-md-6">
              <select name="listing_type" class="form-select" required>
                <option value="available">For Sale & Swap</option><option value="sale_only">Sale Only</option><option value="swap_only">Swap Only</option>
              </select>
            </div>
            <div class="col-md-6"><input type="file" name="item_photo" class="form-control"></div>
