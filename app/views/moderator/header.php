    ...
    <div class="collapse navbar-collapse" id="mainNav">
      ...
      <div class="d-flex align-items-center gap-2">
        ...
        <?php else: ?>            <?php if (isset($_SESSION['user_role']) && in_array(strtolower($_SESSION['user_role']), ['admin', 'moderator'])): ?>
              <a href="/moderator" class="btn btn-warning rounded-pill px-3 fw-bold text-dark" style="background:#c4956a; border-color:#c4956a; color:#fff !important;">Moderator Panel</a>
            <?php endif; ?>   
